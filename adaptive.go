...
func main() {
	...
	lambda := flag.Float64("lambda", 0.5, "Fator de suavização para EWMA")
	alpha := flag.Float64("alpha", 0.05, "Fator alpha para previsão do aPBFT")
	tdelay := flag.Float64("tdelay", 2.0, "Latência máxima tolerada pelo sistema (Tdelay)")
